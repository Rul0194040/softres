...
echo -e "${RED}";
echo "       All your tables belog to us, and will be dropped..."
echo -e "${NC}";
echo "";
...
echo "";
echo "";
echo -e "       ${RED}¡¡¡ The following tables will be dropped !!!"
echo "";
echo -e "$FINAL ${NC}";
echo "";
...
echo "";
mysql --protocol=TCP --user=$MYSQL_USER --host=$MYSQL_HOST --port=$MYSQL_PORT $MYSQL_DB -e "SET foreign_key_checks = 0; $DROP_FOUND; SET foreign_key_checks = 1;"
echo -e "       ${RED}¡It's done!${NC}"
echo "";
echo "       There is no more tables."
echo "";
