...
export class kg1633204048996 implements MigrationInterface {
    name = 'kg1633204048996'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`softres\`.\`insumos\` ADD \`pesoDrenado\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`softres\`.\`insumos\` DROP COLUMN \`merma\``);
        await queryRunner.query(`ALTER TABLE \`softres\`.\`insumos\` ADD \`merma\` int NULL`);
