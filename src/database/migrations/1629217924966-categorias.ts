...
export class categorias1629217924966 implements MigrationInterface {
    name = 'categorias1629217924966'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`softres\`.\`insumos\` ADD \`categoriaId\` int NOT NULL`);
    }
